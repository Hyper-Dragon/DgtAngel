 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::dgt::CallbackResponse>> RegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::dgt::CallbackResponse>>(RegisterCallbacksRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dgt::CallbackResponse>> AsyncRegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq, void* tag) {
    ...
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dgt::CallbackResponse>> PrepareAsyncRegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq) {
    ...
    class async_interface {
     public:
      ...
      virtual void RegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty* request, ::grpc::ClientReadReactor< ::dgt::CallbackResponse>* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientReaderInterface< ::dgt::CallbackResponse>* RegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::dgt::CallbackResponse>* AsyncRegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::dgt::CallbackResponse>* PrepareAsyncRegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReader< ::dgt::CallbackResponse>> RegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::dgt::CallbackResponse>>(RegisterCallbacksRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::dgt::CallbackResponse>> AsyncRegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::dgt::CallbackResponse>>(AsyncRegisterCallbacksRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::dgt::CallbackResponse>> PrepareAsyncRegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq) {
    ...
    class async final :
     ...
     public:
      ...
      void RegisterCallbacks(::grpc::ClientContext* context, const ::dgt::Empty* request, ::grpc::ClientReadReactor< ::dgt::CallbackResponse>* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientReader< ::dgt::CallbackResponse>* RegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request) override;
    ::grpc::ClientAsyncReader< ::dgt::CallbackResponse>* AsyncRegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::dgt::CallbackResponse>* PrepareAsyncRegisterCallbacksRaw(::grpc::ClientContext* context, const ::dgt::Empty& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status RegisterCallbacks(::grpc::ServerContext* context, const ::dgt::Empty* request, ::grpc::ServerWriter< ::dgt::CallbackResponse>* writer);
  };
  ...
  class WithAsyncMethod_RegisterCallbacks : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status RegisterCallbacks(::grpc::ServerContext* /*context*/, const ::dgt::Empty* /*request*/, ::grpc::ServerWriter< ::dgt::CallbackResponse>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestRegisterCallbacks(::grpc::ServerContext* context, ::dgt::Empty* request, ::grpc::ServerAsyncWriter< ::dgt::CallbackResponse>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_RegisterCallbacks() {
      ::grpc::Service::MarkMethodCallback(21,
          new ::grpc::internal::CallbackServerStreamingHandler< ::dgt::Empty, ::dgt::CallbackResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::dgt::Empty* request) { return this->RegisterCallbacks(context, request); }));
    }
  ...
  class WithSplitStreamingMethod_RegisterCallbacks : public BaseClass {
   ...
   public:
    WithSplitStreamingMethod_RegisterCallbacks() {
      ::grpc::Service::MarkMethodStreamed(21,
        new ::grpc::internal::SplitServerStreamingHandler<
          ::dgt::Empty, ::dgt::CallbackResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerSplitStreamer<
                     ::dgt::Empty, ::dgt::CallbackResponse>* streamer) {
    ...
    virtual ::grpc::Status StreamedRegisterCallbacks(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::dgt::Empty,::dgt::CallbackResponse>* server_split_streamer) = 0;
  };
